...
def lambda_handler(event, context):
    ...
    url = 'https://www.shelterluv.com/api/v3/available-animals/5710?species=Dog&embedded=1&iframeId=shelterluv_wrap_1601325966061&columns=1'
    ...
    for OldDog in OldDogScan:
        OldDogsDict[OldDog['dog_name']] = OldDog
